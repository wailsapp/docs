<template>
  <main class="home" aria-labelledby="main-title">
    <header class="hero">
      ...
      <p
        class="description"
        style="margin-top: -3rem; color: #000;"
      ...
      <div id="outer">
        <div
          id="inner"
          class="action"
          style="margin-top: -2.5rem; height: 4rem;"
        ...
        >
          <NavLink class="action-button" :item="actionLinkTwo"/>
        </div>
      </div>
    </header>

    <div class="features" style="margin-top: 0rem" v-if="data.features && data.features.length">
